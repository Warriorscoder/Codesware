  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      <div className="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
        ...
        <h1 className="text-gray-900 text-3xl title-font font-medium mb-4">Order id: #123432</h1>
        <div className="flex mb-4">
          ...
          <a className="flex-grow border-b-2 border-gray-300 py-2 text-lg px-1">Total Price</a>
        </div>
        ...
        <div className="flex mt-4">
          <span className="title-font font-medium text-2xl text-gray-900">Subtotal: ₹1500</span>
